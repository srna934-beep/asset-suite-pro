...
export function AdminOnly({ children, title = "غير مصرح" }: { children: ReactNode; title?: string }) {
    ...
    return (
      <DashboardLayout title="غير مصرح" icon={<div className="grid h-11 w-11 place-items-center rounded-2xl bg-rose-100 text-rose-700"><ShieldAlert className="h-6 w-6" /></div>}>
        <div className="rounded-2xl border border-rose-200 bg-rose-50 p-8 text-center">
          ...
          <h2 className="text-lg font-extrabold text-rose-900">هذه الصفحة مخصصة لمدراء النظام فقط</h2>
